...
import com.ram.ems_backend.exception.ResourceNotFoundException;
import org.springframework.stereotype.Service;

import com.ram.ems_backend.dto.EmployeeDto;
import com.ram.ems_backend.entity.Employee;
import com.ram.ems_backend.mapper.EmployeeMapper;
import com.ram.ems_backend.repository.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public EmployeeDto getEmployeeById(Long employeeId) {
		Employee emp = employeeRepository.findById(employeeId).orElseThrow(()->new ResourceNotFoundException("Employee not exist with given Id"+employeeId));
